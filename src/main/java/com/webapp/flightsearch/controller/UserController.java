...
public class UserController {
    ...
    public ResponseEntity<Map<String, Object>> bookmarkFlight(@PathVariable String userName, @RequestBody BookmarkDto savedBookmark) {
        ...
        bookmarkWriter.saveBookMarkToFirestore(firestore, flightBookmark);
