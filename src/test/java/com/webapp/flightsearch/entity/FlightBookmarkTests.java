...
public class FlightBookmarkTests {
    ...
    public void testGetAndSetId() {
        ...
        assertEquals(id, flightBookmark.getId(), "The ID getter or setter does not work as expected.");
    }
    ...
    public void testGetAndSetUserName() {
        ...
        assertEquals(userName, flightBookmark.getUserName(), "The UserName getter or setter does not work as expected.");
    }
